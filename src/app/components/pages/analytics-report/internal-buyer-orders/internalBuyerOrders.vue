          ...
          <div class="card p-0 order-filter-list">
            <div class="card-body p-0">
              ...
              >
                ...
                <template v-slot:cell(Quantitiy)="data">
                  <p class="d-none d-lg-block d-md-block d-xl-block">{{ data.value }}</p>
                </template>
                ...
                <template v-slot:cell(Related)="data">
                  <a
                      ...
                      <div class="text-right">
                        ...
                        >
                          ...
                          <li>
                            <router-link
                              class="dropdown-item"
                              to="/order/order-detail/1000123456716"
...
<script src="./internalBuyerOrders.js"></script>
<style src="./internalBuyerOrders.scss" lang="scss" scoped/>
